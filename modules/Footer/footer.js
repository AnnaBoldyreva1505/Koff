  ...
  getHTML() {
    return `
       <div class="footer__contacts contacts">
          <a href="tel:+77272951951" class="contacts__phone">
            <svg
        ...
        <ul class="footer__developer-list">
          <li class="footer__developer-item">
            <span>Designer:</span>
            <a href="#" class="footer__developer-link" target="_blank"
              >Anastasia Ilina</a
            >
          </li>
          <li class="footer__developer-item">
            <span>Developer:</span>
            <a
              href="https://github.com/AnnaBoldyreva1505"
